...
public class RemoveCollectionAuditWorkUnit extends AbstractCollectionAuditWorkUnit {
    ...
    public RemoveCollectionAuditWorkUnit(String entityName, Serializable id, Object entity, PersistentCollection persistentCollection) {
